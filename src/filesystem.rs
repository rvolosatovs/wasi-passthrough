...
use crate::bindings::wasi::filesystem::types::{Descriptor, DirectoryEntryStream, Filesize};
use crate::Passthrough;

impl<T: ?Sized> exports::wasi::filesystem::preopens::Guest for Passthrough<T> {
    fn get_directories() -> Vec<(exports::wasi::filesystem::types::Descriptor, String)> {
        todo!()
    }
}

impl<T: ?Sized> exports::wasi::filesystem::types::Guest for Passthrough<T> {
