...
impl<T: ?Sized> exports::wasi::io::error::Guest for Passthrough<T> {
    type Error = Error;
}
...
impl<T: ?Sized> exports::wasi::io::streams::Guest for Passthrough<T> {
...
impl<T: ?Sized> exports::wasi::io::poll::Guest for Passthrough<T> {
